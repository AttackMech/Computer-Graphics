/* Athabasca University
   ...
   Program: The purpose of this program is to demonstrate the use of a recursive ray tracing algorithm to
			calculate lighting in an OpenGL program.  The scene is of a red square on a reflective gray
			surface.  The scene is made up of individual rectangles.  Each rectangle uses a ray cast from
			the viewer to determine the local colour of the individual square.
...
void main(int argc, char **argv) {
	...
	int windowHandle = glutCreateWindow("Comp390 - TME 4 Program 1");
